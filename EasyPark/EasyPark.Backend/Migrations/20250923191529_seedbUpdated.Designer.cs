...
namespace EasyPark.Backend.Migrations
{
    ...
    [Migration("20250923191529_seedbUpdated")]
    partial class seedbUpdated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblBahium", b =>
                {
                    ...
                    b.HasKey("IdBahia")
                        .HasName("PK__tblBahia__D875E6625E3EDF4F");
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblCliente", b =>
                {
                    ...
                    b.HasKey("IdCliente")
                        .HasName("PK__tblClien__885457EE33DA3B55");

                    b.HasIndex(new[] { "Documento" }, "UQ__tblClien__A25B3E61B505D38F")
                        .IsUnique();
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblEmpleado", b =>
                {
                    ...
                    b.HasKey("IdEmpleado")
                        .HasName("PK__tblEmple__5295297C29D6629A");

                    b.HasIndex("IdRol");

                    b.HasIndex(new[] { "Documento" }, "UQ__tblEmple__A25B3E61B90254FB")
                        .IsUnique();
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblFactura", b =>
                {
                    ...
                    b.HasKey("IdFactura")
                        .HasName("PK__tblFactu__3CD5687E48370FA5");
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblRol", b =>
                {
                    ...
                    b.HasKey("IdRol")
                        .HasName("PK__tblRol__3C872F76CDB91D2A");
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblTarifa", b =>
                {
                    ...
                    b.HasKey("IdTarifa")
                        .HasName("PK__tblTarif__550711E148F6FA3D");
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblTicketEntradum", b =>
                {
                    ...
                    b.HasKey("IdTicket")
                        .HasName("PK__tblTicke__22B1456F07AC3333");
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblUsuario", b =>
                {
                    ...
                    b.HasKey("IdUsuario")
                        .HasName("PK__tblUsuar__645723A6DE4FF6B2");
            ...
            modelBuilder.Entity("EasyPark.Shared.Entities.TblVehiculo", b =>
                {
                    ...
                    b.HasKey("Placa")
                        .HasName("PK__tblVehic__0C057424C1E7058F");
